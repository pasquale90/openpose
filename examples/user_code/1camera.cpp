...
void configureWrapper(op::Wrapper& opWrapper)
{
    try
    {
        ...
        // cameraSize
        const auto cameraSize = op::flagsToPoint(op::String(FLAGS_camera_resolution), "730x730");
        
        std::cout<<"cameraSize"<<cameraSize<<" type "<<typeid(cameraSize).name()<<std::endl;
        // outputSize
        const auto outputSize = op::flagsToPoint(op::String(FLAGS_output_resolution), "730x730");
        // netInputSize
